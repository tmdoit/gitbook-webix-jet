...
* The ability to [show views in new windows](part-iv-jetview-and-jetapp-api/jetview-api.md#showing-a-subview-in-a-new-window)
...
* [*getUrl()*](part-iv-jetview-and-jetapp-api/jetview-api.md#this-geturl) and [*getUrlString()*](part-iv-jetview-and-jetapp-api/jetview-api.md#this-geturlstring) for [app](part-iv-jetview-and-jetapp-api/jetapp-api.md#app-geturl) and view
* *removeView()* of Webix widgets triggers *destroy()* of the Jet views inside them
* [*getSubView()*](part-iv-jetview-and-jetapp-api/jetapp-api.md#app-getsubview) and [*contains()*](part-iv-jetview-and-jetapp-api/jetapp-api.md#app-contains) can be called for JetApp
...
* JetView has the [refresh\(\) method](part-iv-jetview-and-jetapp-api/jetview-api.md#this-refresh)
...
* [**this.$$\(\)**](ppart-iv-jetview-and-jetapp-api/jetview-api.md#this-usdusd) returns [widgets from the current Jet view only](part-ii-webix-jet-in-details/referencing-views.md#5-referencing-webix-widgets)
...
* new API:
  * [getParam](part-iv-jetview-and-jetapp-api/jetview-api.md#this-getparam) and [setParam](part-iv-jetview-and-jetapp-api/jetview-api.md#this-setparam) methods to get/set URL parameters
  * [getUrl](part-iv-jetview-and-jetapp-api/jetview-api.md#this-geturl)
...
* [_show_](part-iv-jetview-and-jetapp-api/jetview-api.md#this-show) and [_getSubView_](part-iv-jetview-and-jetapp-api/jetview-api.md#this-getsubview) APIs updated
* _this.ui_ updated
  * allows to define [custom HTML parent](part-iv-jetview-and-jetapp-api/jetview-api.md#optional-container-parameter)
